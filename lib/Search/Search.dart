            ...
            child:Column(
                children: <Widget>[
                  Container(
                    ...
                    child:ListTile(
                        title:Text('Fish', style: TextStyle(fontSize: 20, letterSpacing: 1),),
                        subtitle: Text('4'),
                        leading: CircleAvatar(radius: 30,backgroundImage: AssetImage('images/1.jpg'),),   
                      ),
                  ),
                  ...
                  Container(
                    ...
                    color: Colors.blue[300],
                    child:ListTile(
                        title:Text('Potato', style: TextStyle(fontSize: 20, letterSpacing: 1),),
                        subtitle: Text('4'),
                        leading: CircleAvatar(radius: 30,backgroundImage: AssetImage('images/1.jpg'),),   
                      ),
                  ),
                  ...
                  Container(
                    ...
                    color: Colors.blue[300],
                    child:ListTile(
                        title:Text('Rice', style: TextStyle(fontSize: 20, letterSpacing: 1),),
                        subtitle: Text('4'),
                        leading: CircleAvatar(radius: 30,backgroundImage: AssetImage('images/1.jpg'),),   
                      ),
                  ),
